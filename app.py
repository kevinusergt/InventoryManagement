...
while True:    
 ...
 if option == 1:
  ...
  servicios.registrar_productos(inventario,nombre,precio,cantidad)     
   ...
   if len(inventario) ==0:
     ...
     print(servicios.buscar_producto(inventario,Buscar_product)) 
    ...
    print('Inventario vacio \n')
     ...
     for producto in inventario:
        if producto['Nombre'].lower() == nombre_buscar.lower():
          ...
          servicios.actualizar_producto(producto, n_nombre, n_precio, n_cantidad)
          break
     else:
    ...
    print('Inventario vacio \n')
     ...
     for producto in inventario:
        if producto['Nombre'].lower() == nombre_eliminar.lower():
          ...
          servicios.eliminar_producto(producto)
